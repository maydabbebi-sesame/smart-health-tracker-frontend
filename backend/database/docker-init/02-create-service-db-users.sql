-- Identical to backend/database/migrations/026_create_service_db_users.sql --
-- duplicated here (rather than symlinked) because docker-entrypoint-initdb.d
-- needs a plain .sql file in this directory, run after 01-dump.sql.
