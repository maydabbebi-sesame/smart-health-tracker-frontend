...
from security import publicize_user
...
def upload_profile_picture():
    ...
    # Save file -- shared with the legacy monolith's backend/uploads during
    # the migration so pictures uploaded via either path stay visible.
    upload_dir = os.path.join(os.path.dirname(__file__), "..", "..", "backend", "uploads", "profile_pictures")
