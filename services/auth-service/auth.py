...
def refresh_token():
    ...
    # The old token isn't explicitly blacklisted (token_version is unchanged)
    # since that would also invalidate the user's other active sessions --
    # it simply remains valid until its own expiry, same as before refresh.
