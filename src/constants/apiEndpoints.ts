...
export const AUTH_ENDPOINTS = {
  ...
  RESEND_VERIFICATION: '/api/auth/resend-verification-code',
...
export const VITAL_ENDPOINTS = {
  RECORD_VITAL: '/api/vitals/record',
  GET_VITALS: '/api/vitals/list',
...
export const APPOINTMENT_ENDPOINTS = {
  ...
  GET_APPOINTMENTS: '/api/appointments/list',
